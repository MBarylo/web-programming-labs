...
let FilesController = class FilesController {
    ...
    uploadFile(file) {
        if (!ALLOWED_MIMES.includes(file.mimetype)) {
            fs.unlink(file.path, () => { });
            throw new common_1.BadRequestException(`Недозволений тип файлу: ${file.mimetype}. Дозволено: image/jpeg, image/png, image/webp`);
        }
    ...
    serveFile(name, res) {
        const filePath = (0, path_1.join)(UPLOADS_DIR, name);
